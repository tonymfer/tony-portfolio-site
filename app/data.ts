...
export const cases: CaseStudy[] = [
  {
    ...
    role: "co-founder / product + frontend system",
    year: "2025–2026",
    image: "/proof/beepworks-home-desktop.png",
    desc: "A Base-native paid attention product and retro-futurist frontend system where users price their inbox, earn for engagement, and unread messages can refund the sender.",
    ...
    artifact: "A shipped Base mini-app plus a high-taste product website: custom pixel/CRT visual language, responsive landing page, full sender flow, onchain reward/payment contracts, Beepi AI composition, BeeperX SDK/API, partner campaign rail, and physical pager roadmap.",
    proofPoints: [
    ...
    right: [
      ...
      "The public website is itself frontend proof: a custom pixel/CRT art direction, responsive hero, strong interaction affordances, and product mechanics explained without generic Web3 landing-page patterns.",
  ...
  },
  {
    ...
    proofPoints: [
      ...
      { text: "Official EWHA-CHAIN recap — Tony led the hands-on Base MiniKit + Mint Club SDK session", href: "https://x.com/ewhachain/status/1966407486166139390" },
    ...
    timeline: [
      ...
      { date: "2025-09", title: "Official EWHA-CHAIN first-session recap", href: "https://x.com/ewhachain/status/1966407486166139390", note: "led a hands-on MiniKit session building Zora-style SocialFi services with the Mint Club SDK" },
